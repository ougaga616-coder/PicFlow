...
export function ShareCardModal({
  ...
  return (
    ...
    >
      <div className="flex max-h-[92vh] w-full max-w-[760px] flex-col overflow-hidden rounded-[20px] border border-[#d8ddd7] bg-[#fbfbf8] shadow-[0_28px_80px_rgba(23,32,28,0.22)] dark:border-[#484848] dark:bg-[#303030] dark:text-neutral-100">
        <div className="flex items-center justify-between gap-4 border-b border-[#dde2dc] px-5 py-3.5 dark:border-[#3b3b3b]">
          <h2 className="text-base font-semibold">分享卡片</h2>
          <button className="icon-button" onClick={onClose} aria-label="关闭" title="关闭">
            <X className="h-4 w-4" />
          </button>
        </div>

        <div className="min-h-0 flex-1 overflow-y-auto bg-[#eef1ec] px-5 py-5 dark:bg-[#282828]">
          <ShareCardPreview
            item={item}
